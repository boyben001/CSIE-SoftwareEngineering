<template>
    <n-card :title="basicdata.name" hoverable class="d-flex m-4 py-2">
        ...
        <div>
            <div class="mb-4"
                style="width: 250px; font-size: 22px; font-weight: 500; border-bottom: 3px solid lightgray">詳細資料
            </div>
